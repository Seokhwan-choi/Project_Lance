...
namespace Lance
{
    public class RankDailyCounter
    {
        ...
        public RankDailyCounter()
        {
            mLastUpdateDateNum = TimeUtil.RankNowDateNum();
        ...
        public void SetServerDataToLocal(JsonData data)
        {
            ...
            if (dateNumTemp >= 20680101)
                dateNumTemp = TimeUtil.RankNowDateNum() - 1;
        ...
        void Update()
        {
            int nowDateNum = TimeUtil.RankNowDateNum();
