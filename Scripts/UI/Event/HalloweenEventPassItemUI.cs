...
namespace Lance
{
    class HalloweenEventPassItemUI : MonoBehaviour, IDynamicScrollViewItem
    {
        HalloweenEvent_PassTabUI mParent;
        ...
        public void Init()
        {
            ...
            mParent = gameObject.GetComponentInParent<HalloweenEvent_PassTabUI>(true);
