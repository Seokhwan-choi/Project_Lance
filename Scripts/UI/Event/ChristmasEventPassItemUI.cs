...
namespace Lance
{
    class ChristmasEventPassItemUI : MonoBehaviour, IDynamicScrollViewItem
    {
        ChristmasEvent_PassTabUI mParent;
        ...
        public void Init()
        {
            ...
            mParent = gameObject.GetComponentInParent<ChristmasEvent_PassTabUI>(true);
