...
namespace Lance
{
    class Spawn_EquipmentTabUI : SpawnTabUI
    {
        ...
        public override void Init(SpawnTab tab)
        {
            ...
            for (int i = 0; i < (int)ItemType.Count; ++i)
            {
                ...
                GameObject spawnItemObj = Util.InstantiateUI("EquipmentSpawnItemUI", spawnItemUIList.transform);
