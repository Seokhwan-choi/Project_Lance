...
namespace Lance
{
    class RankProfile_AccessoryItemUI : MonoBehaviour
    {
        public void Init(string id, int level, int reforgeStep)
        {
            ...
            var sliderEquipmentCount = gameObject.FindComponent<Slider>("Slider_AccessoryCount");
            sliderEquipmentCount.value = 0f;

            var textEquipmentCount = gameObject.FindComponent<TextMeshProUGUI>("Text_AccessoryCount");
