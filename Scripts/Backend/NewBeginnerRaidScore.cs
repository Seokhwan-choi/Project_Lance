...
namespace Lance
{
    public class NewBeginnerRaidScore : AccountBase
    {
        ...
        public override void RandomizeKey()
        {
            ...
            mMoveToNew.RandomizeCryptoKey();
        }

        public override string GetTableName()
        {
            return "NewBeginnerRaidScore";
        }
        ...
        public override Param GetParam()
        {
            ...
            param.Add("MoveToNew", (bool)mMoveToNew);
        ...
        protected override void SetServerDataToLocal(JsonData gameDataJson)
        {
            ...
            bool moveToNewTemp = false;

            if (gameDataJson.ContainsKey("MoveToNew"))
            {
                bool.TryParse(gameDataJson["MoveToNew"].ToString(), out moveToNewTemp);
            }

            mMoveToNew = moveToNewTemp;
        }
    }
}