...
namespace Lance
{
    class EventPassItemUI : MonoBehaviour, IDynamicScrollViewItem
    {
        SummerEvent_PassTabUI mParent;
        ...
        public void Init()
        {
            ...
            mParent = gameObject.GetComponentInParent<SummerEvent_PassTabUI>(true);
