...
namespace Lance
{
    class ChuseokEventPassItemUI : MonoBehaviour, IDynamicScrollViewItem
    {
        ChuseokEvent_PassTabUI mParent;
        ...
        public void Init()
        {
            ...
            mParent = gameObject.GetComponentInParent<ChuseokEvent_PassTabUI>(true);
