 ...
 */
 ...
 namespace Mosframe {
    ...
    public abstract class DynamicScrollView : UIBehaviour {
        ...
        public bool IsAllowIsBottomPos()
        {
            // 맨밑에서 아이템 절반 만큼의 정도에 위치인지 확인
            return Mathf.Abs(this.contentAnchoredPosition - (this.viewportSize - this.contentSize)) < this.itemSize;
        }
        ...
        void OnSeedData()
        {
            ...
            for (var i = 0; i < itemCount; ++i)
            {
                ...
                itemRect.anchoredPosition = this.direction == Direction.Vertical ?
                    new Vector2(0, -this.itemSize * i) :
                    new Vector2(this.itemSize * i, 0);
